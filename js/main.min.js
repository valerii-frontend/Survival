...
const swiper=new Swiper(".swiper",{slideToClickedSlide:!0,pagination:{el:".main__pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});window.addEventListener("load",(function(e){document.querySelectorAll(".swiper-pagination-bullet").forEach((e,i)=>{e.innerHTML=i<10?"0"+(i+1):i+1})}));